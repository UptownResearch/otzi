        ...
        try:
            if 'subscribe' in message:
                ...
                if action == 'partial':
                    ...
                    if table not in ['order', 'orderBookL2'] and len(self.data[table]) > BitMEXWebsocket2.MAX_TABLE_LEN:
                        self.data[table] = self.data[table][int(BitMEXWebsocket2.MAX_TABLE_LEN / 2):]
