...
API_KEY = "X3WSoJ_0_0fE6NDzMpuQJppr"
API_SECRET = "Kkz2rhQ3XLBLG6V0SlT61IGmTvvfQpVBYlBZsM4taO21yTBI"
...
WS_LOG_FILE = os.path.expanduser("~") + "/log/smm/websockets/" + f"{opendate:%Y-%m-%d}" + ".log" 
