...
from market_maker.ws.BitMEXWebsocket2 import BitMEXWebsocket2
...
class BitMEX2(object):
    ...
    def __init__(self, base_url=None, symbol=None, apiKey=None, apiSecret=None,
        ...
        # Create websocket for streaming data
        self.ws = BitMEXWebsocket2(base_url, symbol)
